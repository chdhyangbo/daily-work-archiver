...
export async function scoreCommitQuality(projectPath, author, days = 30, outputDir) {
...
function calculateQualityScore(subject) {
    let score = 50;
    const details = [];
    // 长度检查
...
//# sourceMappingURL=commit-quality-scorer.js.map