...
import { addGoal } from './goal-tracker.js';
import { createInterface } from 'readline';
export async function interactiveGoalSetup(dataDir) {
    ...
    try {
        ...
        logger.error(`创建目标时出错: ${error.message}`);
    }
    finally {
        rl.close();
    }
}
function getDefaultDeadline(level) {
    const now = new Date();
    switch (level) {
        case 'yearly':
...
//# sourceMappingURL=interactive-goal.js.map