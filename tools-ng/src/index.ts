...
import { getGitStatsByDay, getTimeStatsByDay, generateWeeklyReport } from './modules/weekly-report.js';
import { generateDailyReport } from './modules/daily-report.js';
import { generateMonthlyReport } from './modules/monthly-report.js';
import { generateAnnualReport } from './modules/annual-report.js';
import { generateResume } from './modules/resume-generator.js';
import { getWeeklyReportData, getResumeData } from './core/git-data-loader.js';
import { analyzeCommits, classifyCommit, suggestCommitMessage } from './modules/commit-classifier.js';
import { scoreCommitQuality } from './modules/commit-quality-scorer.js';
...
import { generateAchievementCard } from './modules/achievement-card-generator.js';
import { initGoalTracker, addGoal, updateGoalProgress, getActiveGoals, generateGoalReport, reviewGoals } from './modules/goal-tracker.js';
import { initReminderSystem, generateReminderSchedules, checkAndSendReminders, generateReminderReport } from './modules/reminder-engine.js';
import { runDailyKickoff, getKickoffHistory } from './modules/daily-kickoff.js';
import { initEnergyTracker, logEnergy, getDailyEnergySummary, analyzeEnergyPattern, generateEnergyReport } from './modules/energy-tracker.js';
import { initGrowthJourney, addSkill, updateSkillLevel, addMilestone, generateGrowthReport, getGrowthTimeline } from './modules/growth-journey.js';
import { initFocusProtector, startFocusSession, endFocusSession, logInterruption, generateFocusReport } from './modules/focus-protector.js';
import { interactiveGoalSetup } from './modules/interactive-goal.js';
import { getWeekRange, getCurrentWeekStart } from './utils/date.js';
    ...
    try {
      ...
      if (action === 'log') {
        ...
        await logEnergy(
          ...
          parseInt(options.energy),
          parseInt(options.focus),
          options.mood,
          options.task,
          options.notes
        );
