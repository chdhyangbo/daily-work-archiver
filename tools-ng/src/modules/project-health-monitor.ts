...
export async function monitorProjectHealth(
  projectPaths: string[],
  author: string,
  days: number = 30,
  ...
  const healthReports: ProjectHealth[] = [];
    ...
    try {
      ...
      for (const gitDir of gitDirs) {
        ...
        try {
          ...
          const health: ProjectHealth = { name: projectName, commits: 0, avgCommitSize: 0, healthScore: 100, issues: [] };
